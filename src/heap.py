...
class Slope(object):
    ...
    def generate(self):
        self.particle.init_particle(
            self.wallPosMin[0] + self.len[0] * 0.03, self.wallPosMax[0] - self.len[0] * 0.03,
            self.wallPosMin[1] + self.len[1] * 0.03, self.wallPosMax[1] - self.len[1] * 0.15,
            self.wallPosMin[2] + self.len[2] * 0.03, self.wallPosMax[2] - self.len[2] * 0.03)
        calm_time = 100
        sub_calm_time = 2000
